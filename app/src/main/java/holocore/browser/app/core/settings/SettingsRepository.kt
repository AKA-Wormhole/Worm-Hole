...
import holocore.browser.app.core.security.EncryptedKeyStore
...
private val Context.settingsDataStore by preferencesDataStore(name = "holocore_settings")
...
class SettingsRepository(private val context: Context) {
    ...
    suspend fun setHomepageUrl(url: String) {
        context.settingsDataStore.edit { prefs ->
            prefs[HOMEPAGE_URL_KEY] = url.trim()
        }
    }
