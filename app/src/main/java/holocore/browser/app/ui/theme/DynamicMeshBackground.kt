...
import holocore.browser.app.core.weather.LastKnownLocation
import holocore.browser.app.core.weather.WeatherClient
import holocore.browser.app.core.weather.WeatherCondition
...
private fun timeOfDayStops(isDark: Boolean): MeshStops {
    ...
    return if (isDark) {
        ...
        MeshStops(
            ...
            bottom = HoloCoreBackgroundDark,
        )
    } else {
        MeshStops(
            top = top,
            mid = lerp(top, Color.White, 0.35f),
            bottom = HoloCoreBackgroundLight,
        )
    }
}
