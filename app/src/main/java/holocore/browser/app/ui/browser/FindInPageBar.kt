...
import holocore.browser.app.core.gecko.FindController
...
fun FindInPageBar(
    ...
    AnimatedVisibility(
        visible = true,
        enter = fadeIn(HoloCoreMotion.fadeIn()) +
            slideInVertically(animationSpec = HoloCoreMotion.chrome()) { fullHeight -> fullHeight },
        exit = fadeOut(HoloCoreMotion.fadeOut()) +
            slideOutVertically(animationSpec = HoloCoreMotion.snappy()) { fullHeight -> fullHeight },
        modifier = modifier,
    ) {
        Surface(
