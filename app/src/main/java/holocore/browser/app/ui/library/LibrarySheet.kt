package holocore.browser.app.ui.library
...
fun LibrarySheet(
    ...
    Column(
        ...
        holocore.browser.app.ui.settings.SettingsHeader(title = "Library", onBack = onDismiss)
    ...
    Surface(
        ...
        Row(
            ...
            Box(
                modifier = Modifier
                    .size(36.dp)
                    .background(HoloCoreSurface.FillRaised, CircleShape),
                contentAlignment = Alignment.Center,
            ) {
                Icon(
