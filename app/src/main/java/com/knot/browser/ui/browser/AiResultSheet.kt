...
/**
 * Shared bottom sheet for showing an [AiRequestState] -- used by both the
 * Assistant (summarize) and Translate menu actions, since both are "run
 * a Gemini call, show loading/result/error" with only the heading text
 * differing.
 */
