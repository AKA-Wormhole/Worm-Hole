...
Pages you visit are fetched directly from those websites. Search queries go to the search engine you chose in Settings. The optional AI assistant sends the text you type (and page context you allow) to the provider you configured, such as Google Gemini, using your own API key.
...
Questions about this policy can be sent through the feedback option in Settings.
