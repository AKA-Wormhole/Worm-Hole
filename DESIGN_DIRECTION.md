# HoloCore visual direction

HoloCore uses its **own core theme**, not Material You / wallpaper dynamic color.
...
- Pill-shaped controls (`HoloCoreShapes` / `HoloCoreSurface.PillShape`)
- Shared surfaces: `HoloCoreSurface`, `HoloCoreTile`, `HoloCoreRow` — every sheet,
...
Do not re-enable Material You dynamic color. The product identity is the HoloCore
